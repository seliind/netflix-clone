...
const isAdded = computed(() => store.state.isAdded);

const increment = () => {
    store.dispatch('incrementFavorites')
}

const decrement = () => {
    store.dispatch('decrementFavorites')
}
...
<template>
    ...
    <div v-else v-for="movie in movieDetails" :key="movie.id" class="movie-details">
        ...
        <div class="content">
            <div class="card">
                <h1>{{ movie.title }}
                    <button v-if="!isAdded" @click="increment" class="favorite-bttn">
                    ...
                    <button v-else @click="decrement" class="favorite-bttn">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
                            <path
